...
import amenities from './db/amenities.json';
      ...
      <article id="usefulinfo">
        ...
        <section className="checklist" id="services">
          ...
          <ul>
            ...
            {services.map((services)=><li>{services.name}</li>)}
          </ul>
        </section>
        <section className="checklist" id="accessibility">
          ...
          <ul>
            ...
            <li>Vibrating alarm clock</li>
            <li>Telephones with volume control</li> */}
            {amenities.map((amenitites)=><li>{amenitites.name}</li>)}
          </ul>
        </section>
      </article>
